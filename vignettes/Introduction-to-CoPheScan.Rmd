...
co <-  capture.output(res.multi <- cophe.multitrait(cophe_multi_trait_data$summ_stat, query.snpid = query.snpid, method = 'single', simplify = T))
# res.multi <- cophe.multitrait(cophe_multi_trait_data$summ_stat, query.snpid = query.snpid, method = 'susie', LDmat = cophe_multi_trait_data$LD)
```
