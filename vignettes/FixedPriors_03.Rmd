...
The priors can also be derived from a larger dataset or from the datasets tested in the cophescan manuscript that match your use case. 
...
<!-- The query variant is `r toString(querysnpid)` -->
...
summary(res.susie)
```
We get a similar result using SuSIE `cophe.susie`. We recommend the use of cophe.susie whenever LD information is available.
