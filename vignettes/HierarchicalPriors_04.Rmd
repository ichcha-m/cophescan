...
```{r mcmcDiagnostics, warning=F, message=F, fig.width=5, fig.height=5, out.width="50%", fig.align="center"}
...
`cophe.hier.res$avg.posterior` contains the posterior probabilities of the hypotheses : $H_n$, $H_a$ and $H_c$ for the queryvariant/querytrait pairs obtained from the hierarchical model.
