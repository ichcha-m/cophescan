...
```{r mcmcDiagnostics, warning=FALSE, message=FALSE, fig.width=5, fig.height=5, out.width="80%", fig.align="center", fig.alt=c("MCMC trace plot for log-likelihood", "MCMC trace plot for alpha parameter", "MCMC trace plot for beta parameter", "MCMC legend")}
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, out.width = "40%", fig.alt = c("PheWAS plot showing -log10(pval) for the query variant across all traits", "PheWAS plot showing ppHa for the query variant across all traits", "PheWAS plot showing ppHc for the query variant across all traits")}
